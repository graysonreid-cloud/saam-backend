def apply_rules(state):
    ...
    # ---------------------------------------------------------
    if state.talk_time_imbalance > 0.75:
        interventions.append({
    ...
    elif state.talk_time_imbalance > 0.55:
        interventions.append({
    ...
    # ---------------------------------------------------------
    if state.blocker_owner_missing:
        interventions.append({
    ...
    if state.ceremony.lower() == "retro":
        if state.participation < 0.4:
            interventions.append({
    ...
    if state.ceremony.lower() == "planning":
        if state.blocker_age_days > 0:
            interventions.append({
    ...
    # ---------------------------------------------------------
    if (
        state.participation < 0.3
        and state.talk_time_imbalance > 0.7
    ):
        interventions.append({
