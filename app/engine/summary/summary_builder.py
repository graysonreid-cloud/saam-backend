...
def build_decision_summary(decisions, best, team_state, confidence=None, team_health=None, **extra):
    """
    Produce a structured, explainable summary of SAAM's reasoning.
    """

    # Order decisions by severity for consistent explainability
    ...
    # Build explainability trace (rule‑level reasoning)
    ...
    return {
        ...
        # Echo full team state for transparency
